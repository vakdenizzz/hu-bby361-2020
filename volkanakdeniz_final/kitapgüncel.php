<?php
    ...
    $KitapAdetBilgisi = mysqli_real_escape_string($baglanti, $_POST['KitapAdetBilgisi']);
    $DilBilgisi = mysqli_real_escape_string($baglanti, $_POST['DilBilgisi']);
    $YazarNo = mysqli_real_escape_string($baglanti, $_POST['YazarNo']);
    $YayineviNo = mysqli_real_escape_string($baglanti, $_POST['YayineviNo']);
    $KitapAcikla = mysqli_real_escape_string($baglanti, $_POST['KitapAcikla']);
    $sorgu = "UPDATE kitapbilgileri SET ISBN = '$ISBN', KitapAdi = '$KitapAdi', KitapAdetBilgisi = '$KitapAdetBilgisi', DilBilgisi = '$DilBilgisi', YazarNo = '$YazarNo', YayineviNo = '$YayineviNo', KitapAcikla = '$KitapAcikla' WHERE KitapKayitNo = $KitapKayitNo";
...
<main role="main" class="container text-center">
     ...
     <h1>Kitap Güncelle</h1>
        ...
        <p><a href="kitap.php">Anasayfaya dön...</a></p>
