...
<main role="main" class="container text-center">
  ...
  <h1>Yazar Güncelle</h1>
         <h1>Yazar Güncelle</h1>
        <form action="yayinevigüncel.php" method="post">
            Yayınevi Adı: <input type="text" value="<?php echo $satir["YayineviAdi"] ;?>" name="YayineviAdi"><br><br>
            yayinevi URL: <input type="text" value="<?php echo $satir["YayineviUrl"] ;?>" name="YayineviUrl"><br><br>
            <input type="hidden" value="<?php echo $satir["YayineviNo"] ;?>" name="YayineviNo"><br>
