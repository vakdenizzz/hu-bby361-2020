<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM kitapbilgileri WHERE KitapKayitNo = $guncellenecek");
    $satir = mysqli_fetch_assoc($sorgu);
    $sorgu2 = mysqli_query($baglanti, "SELECT *, CONCAT(YazarAdi, ' ', YazarSoyad) AS AdSoyad FROM yazarbilgileri");
...
<main role="main" class="container text-center">
  ...
  <h1>Kitap Güncelle</h1>
           <form action="kitapgüncel.php" method="post">
            ISBN: <input type="text" value="<?php echo $satir["ISBN"] ;?>" name="ISBN"><br>
            Kitap Adı: <input type="text" value="<?php echo $satir["KitapAdi"] ;?>" name="KitapAdi"><br>
            Kitap Adet Bilgisi: <input type="text" value="<?php echo $satir["KitapAdetBilgisi"] ;?>" name="KitapAdetBilgisi"><br>
            Dil Bilgisi: <input type="text" value="<?php echo $satir["DilBilgisi"] ;?>" name="DilBilgisi"><br>
            Kitap Açıkla: <input type="text" value="<?php echo $satir["KitapAcikla"] ;?>" name="KitapAcikla"><br>
