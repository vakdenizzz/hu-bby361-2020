<?php
    ...
    $sorgu = "INSERT INTO kitapbilgileri (KitapAdi, ISBN, KitapAdetBilgisi, DilBilgisi, YazarNo, YayineviNo, KitapAcikla)
            VALUES ('$KitapAdi', '$ISBN', '$KitapAdetBilgisi', '$DilBilgisi', '$YazarNo', '$YayineviNo', '$KitapAcikla')";
